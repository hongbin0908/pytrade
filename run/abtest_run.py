...
if __name__ == '__main__':
    ...
    abtest_confs = {
        ...
        "TfDnn":  MyConfStableLTa(classifier=TfDnn(nb_epoch=30),is_adj=False, score=5),
        "TfDnn":  MyConfStableLTa(classifier=TfDnn(nb_epoch=20),is_adj=False, score=5),
        "TfDnn":  MyConfStableLTa(classifier=TfDnn(nb_epoch=10),is_adj=False, score=5),
        "TfDnn":  MyConfStableLTa(classifier=TfDnn(nb_epoch=40),is_adj=False, score=5),
