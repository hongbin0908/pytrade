...
yeod.main2(10, "/home/hongbin/misc/nginx/html/yeod/sp500_snapshot_20091231_%s.zip" % last_trade_date, yeod.sp500_snapshot("20091231").get_syms())
yeod.main2(10, "/home/hongbin/misc/nginx/html/yeod/sp500_snapshot_20101207_%s.zip" % last_trade_date, yeod.sp500_snapshot("20101207").get_syms())
