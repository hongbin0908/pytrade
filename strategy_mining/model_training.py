...
if __name__ == "__main__":
    ...
    adjust_close = []
    volume = []
#    file_list = ['tmp/A-2010-yahoofinance.csv','tmp/AA-2010-yahoofinance.csv','tmp/AAPL-2010-yahoofinance.csv','tmp/ABC-2010-yahoofinance.csv','tmp/ABT-2010-yahoofinance.csv','tmp/ACE-2010-yahoofinance.csv','tmp/ACN-2010-yahoofinance.csv','tmp/ACT-2010-yahoofinance.csv','tmp/ADBE-2010-yahoofinance.csv','tmp/ADI-2010-yahoofinance.csv','tmp/ADM-2010-yahoofinance.csv','tmp/ADP-2010-yahoofinance.csv','tmp/ADS-2010-yahoofinance.csv','tmp/ADSK-2010-yahoofinance.csv','tmp/AEE-2010-yahoofinance.csv','tmp/AEP-2010-yahoofinance.csv','tmp/AES-2010-yahoofinance.csv','tmp/AET-2010-yahoofinance.csv','tmp/AFL-2010-yahoofinance.csv','tmp/AGN-2010-yahoofinance.csv']
#    file_list = ['tmp/A-2010-yahoofinance.csv', 'tmp/AA-2010-yahoofinance.csv']
